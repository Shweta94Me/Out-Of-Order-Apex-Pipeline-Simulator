...
typedef struct CPU_Stage
{
    ...
    //      Since ROB_Entry_node is LinkedList Node, all instructions following this instruction can be
    //      obtained using the 'next' pointers, and can be squashed
    //      Refer functions: BIS_squash , ROB_squash_after
